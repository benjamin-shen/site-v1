      ...
      content={
        <div>
          ...
          <p>
            ...
            and discussion through Dbot's (sometimes unexpected) responses. Most
            of the application is data-driven, so it's easy to add commands,
            change keywords, and update content.
          </p>
          <p>
            ...
            <code>debug</code> flag in a test environment.
          </p>
        </div>
      }
      tags={["archived"]}
